...
%Taken together with the lack of change in glucose uptake and CAT production when control is removed (Fig.~\ref{fig:CarbonBoth}), this suggests that allosteric control is not the limiting factor to CAT production.
...
\begin{figure}[ht]
\centering
\includegraphics[width=1.00\textwidth,trim=0 0 263 0,clip]{./Figures/ClusterCAT.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=1.15\textwidth,trim=0 0 263 0,clip]{./Figures/ClusterSystem.pdf}
\caption{Normalized first-order and pairwise sensitivities of system state to rate constants. A (most sensitive parameters): hexokinase run by GTP, and lactate dehydrogenase forward reaction. B: }
