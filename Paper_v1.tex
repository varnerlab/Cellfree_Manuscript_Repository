...
To explain where the remainder of carbon was going, we performed a carbon balance for the best-fit set (Fig.~\ref{fig:Carbon_Balance}).
...
For case ii, the optimal CAT carbon yield decreased to 48.9\% $\pm$ 3.5\% (Fig.~\ref{fig:oxKO_ssFBA_yields}D, middle).
...
For cases i and ii the energy efficiencies were 72.1\% and 71.2\%, respectively, while for case iii it was only 5.1\%.
