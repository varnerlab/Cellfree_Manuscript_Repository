...
\caption{Total-order global sensitivities for limiting all controllable initial conditions}
...
\caption{Total-order global sensitivities for each amino acids in the case that each of them are unbounded respectively.}
...
\caption{Global sensitivity analysis for alternative carbon sources while glutamic acid as the indication of amino acids.}
