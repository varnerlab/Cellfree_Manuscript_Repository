...
\caption{Total-order global sensitivities of protein export flux to amino acid import fluxes, with flux upper bounds set to 0.5 mM/hr.}
...
\caption{Total-order global sensitivities of protein export flux to amino acid import fluxes, with each amino acid flux unbounded respectively.}
...
\caption{Total-order global sensitivities of protein export flux to glutamic acid, oxygen and glucose import fluxes, and translation initiation rate, in the case of four organic acid export flux upper bounds set to 0.1 mM/hr, whereas organic acid export fluxes are unbounded in the control.}
