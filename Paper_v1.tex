...
The transcription and translation rates were modeled using the template reactions: [FILL IN OR REFERENCE TEMPLATE TABLE].
...
\end{equation}
The first term in the brackets denotes the maximum rate of transcription, where $R_{1}$ denotes the concentration of RNA polymerase, $v_{TX}$ denotes the RNA polymerase elongation rate (nt/hr), $l_{G}$ denotes the gene length in nucleotides, and the last term describes T7 promoter activity, where $K_{T7}$ quantifies T7 RNA polymerase binding [REF-HERE].
...
\end{equation}
The first term in brackets denotes the maximum translation rate, where $K_{P}$ denotes the polysome amplification constant, $R_{2}$ denotes the ribosome concentration, $v_{TL}$ denotes the ribosome elongation rate (amino acids per hour), $l_{P}$ denotes the number of amino acids in the protein of interest, and $mRNA_{SS}$ denotes the steady-state mRNA concentration:
\begin{equation}
