...
The best-fit set, $\Delta$app, and experimental dataset had efficiencies of 1.8-1.9\%, $\Delta$nuo had an efficiency of 1.6\%, and $\Delta$cyd and $\Delta$cyd$\Delta$nuo$\Delta$app had efficiencies of 0.6\%.
...
The unconstrained theoretical maximum CAT carbon yield (case i) was 36.3\% $\pm$ 2.0\% (Fig.~\ref{fig:CATProdYield}B, left); this represents optimal network performance if glucose, oxygen and amino acids were produced or consumed at their upper bounds, and transcription and translation were unbounded.
...
%By comparison, the best-fit parameter set for the kinetic model predicted a CAT carbon yield of 8.6\% $\pm$ 0.4\%, equivalent to 23\% of the theoretical maximum (i) and 35\% of the physiological case (ii).
...
%The model and experimental yields were 35\% of the physiologically constrained case.
...
For flux balance analysis, arginine and glutamate were excluded from the yield calculations, as no experimental measurements were available for these amino acids.
...
%      \hline
%        & Best-fit & $\Delta$cyd & $\Delta$nuo & $\Delta$app & $\Delta$cyd $\Delta$nuo $\Delta$app & Data \\ \hline \hline
%        \multicolumn{7}{|c|}{Carbon Produced (mM)} \\ \hline
%        CAT & 20.9 & 6.5 & 18.1 & 21.4 & 5.1 & 21.6 \\ \hline \hline
%        \multicolumn{7}{|c|}{Carbon Consumed (mM)} \\ \hline
...
%        VAL & 1.4 & 0.4 & 1.2 & 1.5 & 0.4 & 2.4 \\ \hline
%        $\Sigma$ & 767.1 & 755.3 & 791.3 & 780.1 & 696.8 & - \\ \hline
%        $\Sigma$ w/o ARG,GLU & 264.3 & 249.3 & 262.0 & 264.6 & 193.7 & 263.7 \\ \hline \hline
%        Yield & 2.7\% & 0.9\% & 2.3\% & 2.7\% & 0.7\% & - \\ \hline
%        Yield w/o ARG, GLU & 7.9\% & 2.6\% & 6.9\% & 8.1\% & 2.7\% & 8.2\% \\ \hline
%    \end{tabular}
%\end{center}
...
\centering
    ...
    \begin{tabular}{lrrrrrr} \toprule
        ...
        Energy Efficiency & 1.8\% & 0.6\% & 1.6\% & 1.8\% & 0.6\% & 1.9\% \\ \bottomrule
%        Efficiencies based on ATP number of 24: 1.811977 & 0.558704 & 1.565814 & 1.849871 & 0.600006 & 1.873067
    \end{tabular}
...
%        ALA  & -3.852  & 0.267  & -6.9\% \\ \hline
        ALA  & - & 0.27 & - \\ \hline
%        ARG  & 1.697  & 0.178  & 10.5\% \\ \hline
%        ASN  & 1.547  & 0.089  & 5.8\% \\ \hline
%        ASP  & 1.875  & 0.214  & 11.4\% \\ \hline
%        CYS  & 1.016  & 0.089  & 8.8\% \\ \hline
        ARG  & 1.70  & 0.18  & 11\% \\ \hline
        ASN  & 1.55  & 0.09  & 6\% \\ \hline
        ASP  & 1.87  & 0.21  & 11\% \\ \hline
        CYS  & 1.02  & 0.09  & 9\% \\ \hline
%        GLN  & -2.278  & 0.214  & -9.4\% \\ \hline
        GLN  & - & 0.21 & - \\ \hline
%        GLU  & 98.526  & 0.232  & 0.2\% \\ \hline
%        GLY  & 1.545  & 0.178  & 11.5\% \\ \hline
%        HIS  & 0.036  & 0.214  & 587.9\% \\ \hline
%        ILE  & 0.16  & 0.16  & 100\% \\ \hline
%        LEU  & 0.231  & 0.232  & 100.2\% \\ \hline
%        LYS  & 1.785  & 0.214  & 12.0\% \\ \hline
%        MET  & 0.16  & 0.16  & 100\% \\ \hline
%        PHE  & 0.356  & 0.356  & 100\% \\ \hline
%        PRO  & 0.481  & 0.125  & 26\% \\ \hline
%        SER  & 0.83  & 0.178  & 21.5\% \\ \hline
%        THR  & 0.857  & 0.232  & 27\% \\ \hline
%        TRP  & 0.089  & 0.089  & 100\% \\ \hline
%        TYR  & 0.12  & 0.196  & 164\% \\ \hline
%        VAL  & 0.285  & 0.285  & 100\% \\ \hline
