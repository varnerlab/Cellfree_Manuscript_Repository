...
To understand whether the CFPS performance was optimal, we calculated the carbon yield and energy efficiency of CAT production (Fig.~\ref{fig:?????}).
...
To explain where the remainder of carbon was going, we performed a carbon balance for the best-fit set.
...
The best-fit set produced CAT with an energy efficiency of 6.4\%.
...
An additional 62\% of energy went to the accumulation of glycolysis metabolites, 6.4\% to TCA cycle metabolites, 0.2\% to pentose phosphate metabolites, and 25\% to acetate and lactate.
...
Lastly, when metabolite constraints were applied with experimental measurements of measurements (case iii), the predicted carbon yield was 6.0\% $\pm$ 2.0\% (Fig.~\ref{fig:oxKO_ssFBA_yields}D, right).
...
By comparison, the best-fit parameter set for the kinetic model predicted a CAT carbon yield of 7.9\%, equivalent to 36\% of the optimal case (i).
...
%        ARG & 10.2 & 9.9 & 1.1 & 0.9 & 1.3 & - \\ \hline
        ...
        GLN & 0.0 & 0.0 & 0.0 & 1.8 & 2.7 & 0.0 \\ \hline
