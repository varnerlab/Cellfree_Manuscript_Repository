...
params_best = readdlm("params_best") # This is the best-fit set
...
#rate[71] = 0 # Uncomment this for cyd knockout
#rate[72] = 0 # Uncomment this for app knockout
#rate[74] = 0 # Uncomment this for nuo knockout
...
#include("PlotFluxGLY.jl")
#include("PlotFluxAXPTotal.jl")
#include("PlotFluxAMP.jl")
#include("PlotFluxNAD.jl")
#include("PlotFluxNADPH.jl")
#include("PlotFluxGXP.jl")
#include("PlotFluxUXP.jl")
#include("PlotFluxQ.jl")
#include("PlotFluxR5P.jl")
